...
# with command line options: --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --conditions 130X_mcRun3_2022_realistic_postEE_v6 --step PAT --geometry DB:Extended --era Run3,run3_miniAOD_12X --python_filename GEN-Run3Summer22EEMiniAODv4-00101_1_cfg.py --fileout file:GEN-Run3Summer22EEMiniAODv4-00101.root --filein file:__INPUT__.root --number 600 --number_out 600 --no_exec --mc
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--eventcontent nevts:600'),
