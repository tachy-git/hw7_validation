...
# with command line options: --mc --eventcontent RAWSIM --datatier SIM --conditions 124X_mcRun3_2022_realistic_v12 --beamspot Rea^Cstic25ns13p6TeVEarly2022Collision --step SIM --geometry DB:Extended --era Run3 --fileout file:sim.root --no_exec --python_filename sim.py
