...
# with command line options: --python_filename RunIISummer20UL16APVRECO_cfg.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:__OUTPUT__.root --conditions 106X_mcRun2_asymptotic_preVFP_v8 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --filein file:__INPUT__.root --era Run2_2016_HIPM --runUnscheduled --no_exec --mc -n 1
