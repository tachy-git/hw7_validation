...
# with command line options: --python_filename RunIISummer20UL17MiniAODv2_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:__OUTPUT__.root --conditions 106X_mc2017_realistic_v9 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --filein file:__INPUT__.root --era Run2_2017 --runUnscheduled --no_exec --mc -n 1
