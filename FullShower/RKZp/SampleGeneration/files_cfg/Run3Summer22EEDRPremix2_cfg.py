...
# with command line options: step2 --mc --eventcontent AODSIM --datatier AODSIM --conditions 124X_mcRun3_2022_realistic_postEE_v1 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --era Run3 --filein file:dr1.root --fileout file:dr2.root --no_exec --python_filename Run3Summer22EEDRPremix2_cfg.py
