...
# with command line options: --python_filename RunIISummer20UL16APVHLT_cfg.py --eventcontent RAWSIM --outputCommand keep *_mix_*_*,keep *_genPUProtons_*_* --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --inputCommands keep *,drop *_*_BMTF_*,drop *PixelFEDChannel*_*_*_* --fileout file:__OUTPUT__.root --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True) --step HLT:25ns15e33_v4 --geometry DB:Extended --filein file:__INPUT__.root --era Run2_2016 --no_exec --mc -n 1
