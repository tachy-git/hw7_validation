...
# with command line options: --mc --eventcontent RAWSIM --datatier SIM --conditions 124X_mcRun3_2022_realistic_postEE_v1 --beamspot Realistic25ns13p6TeVEarly2022Collision --step SIM --geometry DB:Extended --era Run3 --fileout file:__OUTPUT__.root --filein file:__INPUT__.root --no_exec --python_filename Run3Summer22EESIM_cfg.py
