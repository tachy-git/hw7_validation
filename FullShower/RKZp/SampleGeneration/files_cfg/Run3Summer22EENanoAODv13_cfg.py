...
# with command line options: --eventcontent NANOEDMAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --conditions 133X_mcRun3_2022_realistic_postEE_ForNanov13_v1 --step NANO --scenario pp --era Run3 --python_filename GEN-Run3Summer22EENanoAODv13-00016_1_cfg.py --fileout file:GEN-Run3Summer22EENanoAODv13-00016.root --filein __INPUT__.root --number 1763 --number_out 1763 --no_exec --mc
...
process.GlobalTag = GlobalTag(process.GlobalTag, '133X_mcRun3_2022_realistic_postEE_ForNanov13_v1', '')
