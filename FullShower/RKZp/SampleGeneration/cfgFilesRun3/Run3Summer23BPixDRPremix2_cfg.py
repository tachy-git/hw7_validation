...
# with command line options: step2 --mc --eventcontent AODSIM --datatier AODSIM --conditions 130X_mcRun3_2023_realistic_v14 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --era Run3_2023 --filein file:dr1.root --fileout file:dr2.root --no_exec --python_filename Run3Summer23DRPremix2_cfg.py
