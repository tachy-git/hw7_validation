...
# with command line options: step1 --mc --eventcontent MINIAODSIM --datatier MINIAODSIM --conditions 124X_mcRun3_2022_realistic_postEE_v1 --step PAT --geometry DB:Extended --era Run3 --filein file:dr2.root --fileout file:miniaod.root --no_exec --python_filename Run3Summer22EEMiniAODv3_cfg.py
