...
# with command line options: Configuration/GenProduction/python/JME-RunIISummer20UL16wmLHEGEN-01293-fragment.py --mc --eventcontent RAWSIM,LHE --datatier GEN,LHE --conditions 124X_mcRun3_2022_realistic_postEE_v1 --beamspot Realistic25ns13p6TeVEarly2022Collision --step LHE,GEN --geometry DB:Extended --era Run3 --fileout file:__OUTPUT__.root --python_filename Run3Summer22EEGEN_cfg.py --no_exec
