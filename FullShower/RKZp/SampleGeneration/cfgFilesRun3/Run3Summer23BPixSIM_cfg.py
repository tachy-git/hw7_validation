...
# with command line options: --mc --eventcontent RAWSIM --datatier SIM --conditions 130X_mcRun3_2023_realistic_v14 --beamspot Realistic25ns13p6TeVEarly2023Collision --step SIM --geometry DB:Extended --era Run3_2023 --filein file:gen.root --fileout file:sim.root --no_exec --python_filename Run3Summer23SIM_cfg.py
