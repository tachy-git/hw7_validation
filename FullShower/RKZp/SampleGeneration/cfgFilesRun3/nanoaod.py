...
# with command line options: step1 --mc --eventcontent NANOEDMAODSIM --datatier NANOAODSIM --conditions 124X_mcRun3_2022_realistic_v12 --step NANO --scenario pp --era Run3 --filein file:miniaod.root --fileout file:nanoaod.root --no_exec --python_filename nanoaod.root
...
process.NANOEDMAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    outputCommands = process.NANOAODSIMEventContent.outputCommands+['keep GenEventInfoProduct_*_*_*']
)
