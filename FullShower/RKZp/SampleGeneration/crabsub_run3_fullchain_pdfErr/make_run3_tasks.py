...
INPUT_ROOT_XRD = "root://cms-xrdr.sdfarm.kr:1095//xrd/store/user/taehee/HerwigSample/RKZp_13p6TeV/RS/hw_nEvt-100000_pdfErr"
...
WORKFLOWS = {
    "Run3Summer22": [
        ...
        ("NanoAOD", "CMSSW_12_6_0", "el8_amd64_gcc10"),
    ],
    "Run3Summer22EE": [
        ("GEN", "CMSSW_12_4_11_patch3", "el8_amd64_gcc10"),
        ("SIM", "CMSSW_12_4_11_patch3", "el8_amd64_gcc10"),
    ...
    "Run3Summer23": [
        ...
        ("NanoAOD", "CMSSW_13_0_14", "el8_amd64_gcc11"),
    ],
    "Run3Summer23BPix": [
        ("GEN", "CMSSW_13_0_14", "el8_amd64_gcc11"),
        ("SIM", "CMSSW_13_0_14", "el8_amd64_gcc11"),
...
for item in "${{cmssw_steps[@]}}"; do
    ...
    case "${{step}}" in
        ...
        MiniAOD|MiniAODv3|MiniAODv4) output="${{step}}.root" ;;
        NanoAOD) output="${{final_output}}" ;;
...
def make_submit(campaign, sample, processes, zpmass_tag, output_base, task_dir):
    ...
    request = f"RKZp_{campaign}_Run3FullChain_pdfErr_{zpmass_tag}_{clean_sample}_{VERSION_TAG}"
...
config.Data.outputDatasetTag = '{campaign}_Run3FullChain_pdfErr_NanoAOD_{VERSION_TAG}'
...
def make_tasks_for_mass(zpmass):
    ...
    outdir = WD / f"crabsub_run3_fullchain_pdfErr_{VERSION_TAG}" / zpmass_tag
    ...
    submit_all_lines = header[:] + [
        ...
        'echo "  submit_2022.sh: Run3Summer22, Run3Summer22EE from CMSSW_12_4_11_patch3 / el8_amd64_gcc10" >&2',
    ...
    for campaign, sample, count, task_dir in tasks:
        ...
        clean_sample = clean_name(sample)
        project = f"crabsub_projects/crab_RKZp_{campaign}_Run3FullChain_pdfErr_{zpmass_tag}_{clean_sample}_{VERSION_TAG}"
